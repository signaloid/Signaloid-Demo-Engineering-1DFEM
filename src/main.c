...
void
init_problem(int* ibc_mode, int* n_quadrature, double* u_start, double* u_end, double* x_start, double* x_end)
{
	/*
	...
	*ibc_mode = 1;
	/*
	 *	NQUAD is the number of quadrature points per subinterval. The program as
	 *	currently written cannot handle any value for NQUAD except 1.
	 */
	*n_quadrature = 1;
	/*
...
double
exact_solution(double x, double x_end)
{
...
/******************************************************************************/
void
build_mesh(double x_grid_sizes[], int ibc_mode, int idx_of_unknown[], int n_basis, int node_indices[], int n_elements,
...
void
assemble(double diag_coeffs[], double left_coeffs[], double right_coeffs[], double f[],
...
void
assemble_noQuadrature(double diag_coeffs[], double left_coeffs[], double right_coeffs[], double f[],
	double x_grid_sizes[], int idx_of_unknown[], int n_basis, int node_indices[], int n_unknowns, int n_quadrature,
	int n_elements, double u_start, double u_end, double x_grid_nodes[], double x_quadrature[])
{
	double aij;
...
void
linear_basis_fn(int il, double x, double* phi_i, double* phi_ix, double x_lower,
	double x_upper)
{
...
void
solve(double diag_coeffs[], double left_coeffs[], double right_coeffs[], double f[], int n_unknowns)
{
	int i;
	/*
...
void
print_problem_summary(int ibc_mode, int n_quadrature, double u_start, double u_end, double x_start, double x_end)
{
	printf("\n");
...
void
print_system(double diag_coeffs[], double left_coeffs[], double right_coeffs[], double f[], int n_unknowns)
{
	int i;
...
void
print_fem_solution(double f[], int ibc_mode, int idx_of_unknown[], int n_elements, int n_unknowns, double u_start,
	double u_end, double x_grid_nodes[], double u_fem[])
{
	int i;
	double u;
...
void
print_exact_solution(double x_start, double x_end, double x_grid_nodes[], double u_exact[])
{
	int i = 0;
